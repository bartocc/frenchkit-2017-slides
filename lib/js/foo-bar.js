...
__decorate([tracked], FooBar.prototype, "firstName", void 0);
__decorate([tracked], FooBar.prototype, "lastName", void 0);
__decorate([tracked('firstName', 'lastName')], FooBar.prototype, "fullName", null);

var __ui_components_foo_bar_template__ = { "id": "q+RUIVak", "block": "{\"symbols\":[],\"statements\":[[6,\"div\"],[7],[0,\"\\n  \"],[6,\"input\"],[9,\"id\",\"first\"],[9,\"type\",\"text\"],[10,\"value\",[18,\"firstName\"],null],[10,\"onkeyup\",[25,\"action\",[[19,0,[\"setFirstName\"]]],null],null],[7],[8],[0,\"\\n  \"],[6,\"input\"],[9,\"id\",\"last\"],[9,\"type\",\"text\"],[10,\"value\",[18,\"lastName\"],null],[10,\"onkeyup\",[25,\"action\",[[19,0,[\"setLastName\"]]],null],null],[7],[8],[0,\"\\n\"],[8],[0,\"\\nHello \"],[1,[18,\"fullName\"],false],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "specifier": "template:/foo-bar/components/foo-bar" } };

var moduleMap = { 'component:/foo-bar/components/foo-bar': FooBar, 'template:/foo-bar/components/foo-bar': __ui_components_foo_bar_template__ };

var resolverConfiguration = { "app": { "name": "foo-bar", "rootName": "foo-bar" }, "types": { "application": { "definitiveCollection": "main" }, "component": { "definitiveCollection": "components" }, "component-test": { "unresolvable": true }, "helper": { "definitiveCollection": "components" }, "helper-test": { "unresolvable": true }, "renderer": { "definitiveCollection": "main" }, "template": { "definitiveCollection": "components" } }, "collections": { "main": { "types": ["application", "renderer"] }, "components": { "group": "ui", "types": ["component", "component-test", "template", "helper", "helper-test"], "defaultType": "component", "privateCollections": ["utils"] }, "styles": { "group": "ui", "unresolvable": true }, "utils": { "unresolvable": true } } };
...
app.renderComponent('foo-bar', containerElement, null);
app.boot();
initializeCustomElements(app, ['foo-bar']);
